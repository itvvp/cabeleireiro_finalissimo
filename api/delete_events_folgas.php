...
$sql = "DELETE FROM events WHERE cabeleireira = ? AND id_tratamento = 9999 AND title = 'Folga' AND start_event >= '2025-12-20 00:00:00' AND start_event < '2028-01-01 00:00:00'";
$params = [$terapeuta_id];
