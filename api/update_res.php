...
if (isset($_POST['id'])) {
    ...
    $troca_cabeleireiro= $_REQUEST['troca_cabeleireiro'];
    ...
    if (! isset($error)) {
        ...
        // echo $sql."<br>";
         ...
         $func=$row["cabeleireira"];
         $cor=$row["color"];

       
        if($troca_cabeleireiro=="troca" and $func=="1")
        {
            
            $func="2";
            $cor="#C27BA0";
        }
        elseif($troca_cabeleireiro=="troca" and $func=="2")
        {
       ...
       // echo $id."<br><br>";
         ...
         $sql="select count(*) as total from events where (('$data_hora_i_c'>start_event and '$data_hora_i_c'<end_event) or ('$data_hora_f'>start_event and '$data_hora_f'<end_event)) and id_tratamento!=9999 and cabeleireira='$func' and id!=$id";
     //   echo $sql."<br><br>";
        $stmt = sqlsrv_query($conn, $sql);
        if ($stmt === false) {
        ...
        if($perfil!=2)
        {
            ...
            ('$data_hora_f'>start_event and '$data_hora_f'<end_event)) and cabeleireira='$func' and id_tratamento=9999";
            $stmt = sqlsrv_query($conn, $sql);
            if ($stmt === false) {
                die(print_r(sqlsrv_errors(), true));
            }
        ...
        else
        {
         ...
         if ($numero_registos>0) {
            ...
            if ($numero_impedimentos>0) {
                ...
                $sql="update events set start_event='$data_hora_i_c' ,end_event='$data_hora_f' ,nome_hospede='$nomehospede' ,quarto='$quartohospede' ,notas='$notashospede',cabeleireira='$func',color='$cor' where id=$id";
