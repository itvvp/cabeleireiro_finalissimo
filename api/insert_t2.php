...
//    $text_color = $_POST['text_color'];
    ...
    */
        ...
        //   $end = date('Y-m-d H:i:s', strtotime($data_hora_i));
            ...
            ('$data_hora_f'>start_event and '$data_hora_f'<=end_event)) and id_tratamento!=9999 and cabeleireira='2'";
           // echo $sql."<br>";
            $stmt = sqlsrv_query($conn, $sql);
            if ($stmt === false) {
                die(print_r(sqlsrv_errors(), true));
...
//echo $perfil."<br>";
            ...
            if ($numero_registos>0) {
                ...
                if ($numero_impedimentos>0) {
                    ...
                    $sql="insert into events(title,start_event,end_event,color,text_color,id_tratamento,nome_hospede,quarto,notas,cabeleireira) values('$title','$data_hora_i_c','$data_hora_f','#6453e9','#ffffff',$id_tratamento,'$NomeHospede','$QuartoHospede','$NotasHospede','2')";
                    //echo $sql."<br>";
                    $stmt = sqlsrv_query($conn, $sql);
                    if ($stmt === false) {
                        die(print_r(sqlsrv_errors(), true));
