...
today = yyyy + '-' + mm + '-' + dd;
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
       ...
       defaultDate: today,
        ...
        eventClick: function(arg) {
         ...
         // console.log("id:"+id);
            $.ajax({
              url:url+"api/getevent_res.php?id="+id,
              type:"POST",
              dataType: 'json',
              data:{id:id},
              success: function(data) {
                  var id_tratamento=data[0].id_tratamento;
                    ...
                    $('#cabeleireira_editar').val(data[0].cabeleireira);
  ...
  //  calendar.setOption('locale', 'pt');
    ...
    $('#editEvent').submit(function(event) {
        ...
        var troca_cabeleireiro = $('#troca_cabeleireiro').val();
        ...
        $.ajax({
            ...
            data        : {
                ...
                startdate:startdate,
                starttime:starttime,
                troca_cabeleireiro:troca_cabeleireiro
            },
            dataType    : 'json',
            encode      : true
        }).done(function(data) {
