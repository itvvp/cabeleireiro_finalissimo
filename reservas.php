...
<head>
    ...
    <script src='calendar6.js'></script>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div id="title-group" class="form-group">
                                                            ...
                                                            <select class="form-control" id="tratamento" name="tratamento" required autocomplete="off">
                                                                <option value="1">Selecione o tratamento</option>
                                                                <?php
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div id="title-group" class="form-group">
                                                        <label class="control-label" for="cabeleireira_editar">Cabeleireira</label>
                                                        <input type="text" class="form-control" disabled  id="cabeleireira_editar"  name="cabeleireira_editar" autocomplete="off">
                                                        <?php   if ($_SESSION["perfil"]==1 or $_SESSION["perfil"]==2) { ?>
                                                            <fieldset class="checkboxsas">
                                                                <label>
                                                                    <input type="checkbox" id="troca_cabeleireiro" name="troca_cabeleireiro" value="troca">
                                                                    Trocar a cabeleireira
                                                                </label>
                                                            </fieldset>
                                                        <?php } ?>
                                                            <!-- errors will go here -->
